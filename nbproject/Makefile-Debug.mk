...
${OBJECTDIR}/abilityTemplates.o: abilityTemplates.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -DSDL_MAIN_HANDLED -D_DEBUG -I../hamlibs/include -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/abilityTemplates.o abilityTemplates.cpp
...
${OBJECTDIR}/attackTemplates.o: attackTemplates.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Werror -DSDL_MAIN_HANDLED -D_DEBUG -I../hamlibs/include -std=c++11 -MMD -MP -MF $@.d -o ${OBJECTDIR}/attackTemplates.o attackTemplates.cpp
